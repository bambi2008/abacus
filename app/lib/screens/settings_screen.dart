...
/// implements the sharing/UI surface; real two-way sync between two devices
/// needs a lightweight backend (Phase 2, not part of the local-first
/// Hive architecture this MVP uses).
class _BuddyStreakTile extends StatelessWidget {
  const _BuddyStreakTile();
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: const Text('Both of you log an expense the same day to keep it alive.'),
